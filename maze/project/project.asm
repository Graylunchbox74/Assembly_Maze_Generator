...
add_to_stack:
    ...
    mov DWORD[stack_x_arr + ebx * 4], eax

    mov eax, DWORD[ebp+12]
    mov ebx, DWORD[stack_size]
    mov DWORD[stack_y_arr + ebx * 4], eax

    mov eax, DWORD[ebp+8]
    mov ebx, DWORD[stack_size]
    mov DWORD[stack_d_arr + ebx * 4], eax

    add DWORD[stack_size], 1
...
top_of_stack:
    ...
    dec esi
    mov eax, DWORD[stack_x_arr + esi * 4]

    mov ebx, DWORD[stack_y_arr + esi * 4]
    mov ecx, DWORD[stack_d_arr + esi * 4]
